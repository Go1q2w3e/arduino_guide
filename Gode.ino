//https://imgur.com/iooPlEY правильное подключение блока питания
//Перед работой убедиться в правильности подключения
...
#define led_2 6
#define led_3 7
// Название датчиков стоит использовать свои даты избежать путонецы. номера контролеров стоит смотреть на приборном считке
// Как правило насос находиться на 4 датчике 
// Свет распологаеться на контролерах 5, 6 и 7 
// Далее номера датчиков зависят от вас и от того куда вы подключили провода контролирующие 
